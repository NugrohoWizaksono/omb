...
var n = {
build_number: "20170208.071502",
git_commit: "23a2e3fc1565c7d4e724ee33b3f6b3d04ca93b02"
};
e.exports = n;
}, function(e, t, n) {
(function(t, i, o, r, s) {
...
re = e.source_ver;
q = e.root;
G = q.$("tmp").$("api_settings");
K = q.$("tmp").$("server_settings");
X = q.$("livechat").$("settings").$("cached$bool");
W = q.$("connection");
Y = W.$("server_retired$bool");
Z = W.$("server_ready$bool");
Z.bindValue(l);
Y.bindValue(u);
H = q.$("livechat").$("ui").$("mockup$bool").getValue();
if (H) W.$("status$string").update("reattached"); else {
q.$("livechat").$("profile").bindValue(c);
...
V = !1;
"visibilityState" in document && "prerender" == document.visibilityState ? document.addEventListener("visibilitychange", t) : Ae.connect();
}
}
}
function a(e) {
...
var t = q.$("livechat").$("account").$("status$string").getValue();
"invalid_account_key" == t && le.warnBadEmbed();
p();
}
O();
}
function c(e) {
e && (te() || ae.IS_POPOUT || e.mid$string && ce.setIdentity(e.mid$string));
}
function u(e) {
J = e === !0;
}
...
function b() {
return oe || W.$("server$string").getValue() || "";
}
function y(e) {
function t() {
clearTimeout(o);
...
function $(e, t) {
if (!H) if (B) t.close(); else {
W.update({
socket_status$string: null
});
we = e;
ue.increment("conn", [ "tries:" + ke ]);
ke = 0;
ue.start("conn_open", t.starttime);
ue.end("conn_open", .25, [ "proxy:" + e ]);
B = t;
B.on("break", k);
B.on("message", E);
B.on("reopen", x);
...
function E(e) {
if (e) {
if (e.raw && e.raw.__messageID in xe) {
var t = xe[e.raw.__messageID];
delete xe[e.raw.__messageID];
t(e);
}
var n = q;
if ("update" in e) {
...
i.splice(0, 2);
i = i.join(".");
(i ? K.$("account").descend(i) : K.$("account")).update(e.update);
le.fullyExtend(e.update, G.getValue("account"));
}
if (/^livechat/.test(e.path) && "account" in e.update) {
K.$("account").update(e.update.account);
le.fullyExtend(e.update.account, G.getValue("account"));
}
if (/^livechat.settings/.test(e.path)) {
var o = e.path.split(".");
o.splice(0, 2);
o = o.join(".");
(o ? K.$("settings").descend(o) : K.$("settings")).update(e.update);
le.fullyExtend(e.update, G.getValue("settings"));
}
...
if (ae.ACCOUNT_KEY) {
B || Ae.connect();
var e = ce.getIdentity(), t = te(), n = q.$("livechat").$("ui").getValue("mobile$bool") ? "mobile" : "desktop", o = q.$("livechat").$("settings").$("theme").getValue("name$string"), r = {
__type: "register",
accountKey: ae.ACCOUNT_KEY,
mID: e,
...
if (q.$("livechat").$("ui").$("popout$bool").getValue()) r.popout = !0; else {
...
function I() {
B && q.$("livechat").$("profile").write({
disconnect_timeout$int: j(B.rtt)
});
}
function T() {
W.update({
...
function N() {
return +new Date() - (B ? B.clock_skew : 0);
}
function R(e) {
Se += 1;
xe[Se] = e;
...
n.path = e.path;
n.value = e.value;
t(e.func) && (n.__messageID = R(e.func));
ye.push(n);
}
if (B && be) for (;ye.length; ) B.send(ye.shift());
}
function P(e) {
return e ? K.getValue(e) : K.getValue();
}
function j(e) {
function t(e) {
return e;
}
var n, i, o = 10 * pe.SECOND, r = 1 * pe.SECOND, s = 120 * pe.SECOND, a = 20 * pe.SECOND;
e = Math.round(e) || 0;
...
Z.unbindValue(l);
Y.unbindValue(u);
q.$("livechat").$("profile").unbindValue(c);
...
ve = [], we = "", be = !1, ye = [], $e = [], Ee = !1, ke = 0, Se = 0, xe = {}, V = z = q = W = B = H = G = K = X = Y = J = Z = Q = ee = te = ne = ie = oe = re = se = null;
}
var V, z, q, W, B, H, G, K, X, Y, J, Z, Q, ee, te, ne, ie, oe, re, se, ae = n(12), ce = n(15), ue = n(28), le = n(21), fe = n(53), de = n(58), he = n(59), pe = n(63), me = {
FLUSH_DELAY_MS: 0,
RECONNECT_DELAY_MS: 1e4
}, ge = 3e3, _e = new he(de), ve = [], we = "", be = !1, ye = [], $e = [], Ee = !1, ke = 0, Se = 0, xe = {}, Ae = r.extend({
init: e,
send: h,
connect: w,
reconnect: m,
disconnect: g,
getConnectionStats: D,
getHost: L,
getServerTime: N,
getServerSettings: P,
...
s(Ae, "meshim_widget_controllers_ConnectionController");
return Ae;
}();
...
DE: [ "de04", "de06", "de08", "de10", "de12", "ie02", "ie04", "ie06", "ie08", "ie10", "ie12", "ie14", "ie16", "de14", "de16", "de18", "de20" ],
